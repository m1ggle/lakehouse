...
//
//    @Override
//    public void open(Configuration configuration) throws SQLException {
...
//            filterColumns(JSON.parseObject(value.getString("data")),tableProcess.getSinkColumns());
//            value.put("sinkTable", tableProcess.getSinkTable());
//            out.collect(value);
//        }else {
//            throw new NotFoundException("Table is not founded");
//        }
//    }
//
//
...
//
//        String[] columns = sinkColumns.split(",");
//        List<String> columnsLists = Arrays.asList(columns);
//        Set<Map.Entry<String, Object>> keySet = data.entrySet();
//        keySet.removeIf(next ->!columnsLists.contains(next.getKey()));
//
//    }
private Connection conn;
    MapStateDescriptor<String, TableProcess> mapStateDescriptor;
